...
var tuiEditor string

var tuiCmd = &cobra.Command{
	Use:     "tui",
	GroupID: "interactive",
	Short:   "Launch the note picker TUI",
	Long:    `Launch an interactive TUI to browse, view, and open your existing notes.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for {
			...
			if m.ShouldOpenFile() {
				if err := svc.OpenInEditor(filename, tuiEditor); err != nil {
					return err
				}
				continue
			}
...
func init() {
	tuiCmd.Flags().StringVarP(&tuiEditor, "editor", "e", "nvim", "Editor to use for opening notes")
}
